SamacSys ECAD Model
246260/1063637/2.50/2/2/Connector
...
(library Library_1
	...
	(patternDef "1725656" (originalName "1725656")
		...
		(layerContents (layerNumRef 28)
			(line (pt -1.5 -3.1) (pt 4.04 -3.1) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.04 -3.1) (pt 4.04 3.1) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4.04 3.1) (pt -1.5 3.1) (width 0.1))
		)
		(layerContents (layerNumRef 28)
	...
	(compDef "1725656" (originalName "1725656") (compHeader (numPins 2) (numParts 1) (refDesPrefix J)
		...
		(attr "Arrow Part Number" "1725656")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/1725656/phoenix-contact?region=nac")
		...
		(attr "Datasheet Link" "https://www.phoenixcontact.com/online/portal/us/?uri=pxc-oc-itemdetail:pid=1725656&library=usen&pcck=P-11-01-05&tab=1&selectedCategory=ALL")
		(attr "Height" "8.65 mm")
	)
